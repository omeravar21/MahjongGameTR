...
namespace MahjongGame.Tiles
{
    public static class TileInteractionSceneValidator
    {
        public static bool ValidateGameplayRoot(Transform gameplayRoot, StringBuilder reportBuilder = null)
        {
            ...
            passed &= ArchetypeSystemValidator.Validate(reportBuilder);
            passed &= VariationSystemValidator.Validate(reportBuilder);
            ...
            passed &= RewardJokerPatternSystemValidator.Validate(reportBuilder);
            ...
            passed &= BoardQualityCheckerSystemValidator.Validate(reportBuilder);
            passed &= EmergencyFallbackSystemValidator.Validate(reportBuilder);
